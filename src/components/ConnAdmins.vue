...
export default {
  data() {
    ...
    if(error === "403"){
      this.errorMessage = "Ce mot de passe est incorrecte"
    }
    if (error === "401") {
      this.errorMessage = "Cette email est incorrecte"
    }
  }
}
</script>
<template>
    ...
    <form :action="apiUrl + '/admins/connexion'" method="post" class="auth-form">
